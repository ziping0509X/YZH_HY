...
# Model
flags.DEFINE_string('model', 'm1', 'Type of model')  #定义数组结构体类型
flags.DEFINE_boolean('dueling', False, 'Whether to use dueling deep q-network') #定义了两个布尔型的结构体类型：是否使用DQN和双Q网络
...
def main(_):
  ...
  width = 750
  height = 1299
  # 大致上可以看做是一个750*1299的画面，这个画面上有横纵三条路，每条路还不确定有几条车道
